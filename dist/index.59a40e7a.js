...
btnFormSubmit.addEventListener("click", (0, _emailDefault.default));
function addEventOnMultipleElements(el, eventType, cb) {
    for(let i = 0, len = el.length; i < len; i++)el[i].addEventListener(eventType, cb);
}
//Nav
...
},{"./email":"6mAiT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6mAiT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["aP7aF","8lRBv"], "8lRBv", "parcelRequire04e2")
